...
export const COMMAND_MATRIX: readonly CommandMatrixEntry[] = [
  ...
  { command: "source batch-status", view: "production-semantic", handles: ["job_id", "committed_count", "resume_command"], notes: "Reads optional registration checkpoint progress without modifying sources or locks." },
  { command: "source discover", view: "production-semantic", handles: ["source_type"], notes: "Optional source inventory namespace; does not create capture phases or production tasks." },
  { command: "source discover lark", view: "production-semantic", handles: ["lark_url", "job_id", "identity", "manifest"], notes: "Discovers a resumable Wiki subtree inventory using one fixed identity." },
  { command: "source fetch", view: "production-semantic", handles: ["source_type"], notes: "Optional standalone capture namespace; no workspace registration or production task is required." },
  { command: "source fetch lark", view: "production-semantic", handles: ["lark_url", "snapshot_dir", "identity", "manifest"], notes: "Captures a portable full document and resource snapshot for later offline source import." },
