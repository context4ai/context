import { prepareCodeAnalysisInput, normalizedVirtualPath, safeCodeSourcePath as safeSourcePath } from "./codeAnalysisInput.js";
...
export async function materializeProjectIndexerParserEntryInput(input: {
  ...
  const result: IndexerParserRuntimeEntryInput = {
    ...
    ...(needsPrepared
      ? {
          prepared_input: await prepareCodeAnalysisInput({
