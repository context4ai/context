...
function candidatePage(record: CandidateRecord, markdown: string): AuditedPage {
  ...
  return {
    metrics: {
      ...
      catalog_lines: quality.catalogLines,
      evidence_enumeration_lines: quality.evidenceEnumerationLines,
      templated_observation_lines: quality.templatedObservationLines,
      normalized_template_repetition_lines: quality.normalizedTemplateRepetitionLines,
      normalized_template_histogram: quality.normalizedTemplateHistogram,
      reader_content_lines: quality.readerContentLines,
