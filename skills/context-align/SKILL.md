...
Apply the procedure in `references/internal-procedures/skill-align-workflow.md` for Node classification gates and align intent procedure. Keep generated payloads on stdin. Do not create scratch files under the workspace or `/tmp`.
