...
| items carry `temporal_prior` / `source_captured_at` / `temporal_disposition`, raw/source_ref boundary diagnostics, or prepared long `proposed.content` / `proposed.summary` | [skill-semantic-reconcile/references/temporal-and-evidence.md](skill-semantic-reconcile/references/temporal-and-evidence.md) |
