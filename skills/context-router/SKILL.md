...
name: context-router
description: >
  Fuzzy router for context operations. Inspect the argument and route to the correct /context:* subcommand. Equivalent to Claude /context:context; use the local `context` CLI for workspace writes.
tools:
  - Bash
---
...
- Public entry: `context-router`
- Claude equivalent: `/context:context`
