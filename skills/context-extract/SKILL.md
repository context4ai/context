...
description: >
  Debug helper: run extraction against a path and print structured results (no files written). Equivalent to Claude /context:extract; use the local `context` CLI for workspace writes.
tools:
  - Bash
---
...
- Public entry: `context-extract`
- Claude equivalent: `/context:extract`
