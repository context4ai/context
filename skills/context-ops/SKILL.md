...
name: context-ops
description: >
  Run operational package tasks such as local build/export, with future publish commands kept under the same entry. Equivalent to Claude /context:ops; use the local `context` CLI for workspace writes.
tools:
  - Bash
---
...
- Public entry: `context-ops`
- Claude equivalent: `/context:ops`
