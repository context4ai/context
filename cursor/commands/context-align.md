...
Apply the procedure in `../skills/skill-align-workflow/SKILL.md` for Node classification gates and structure-decision procedure. Keep generated payloads on stdin. Do not create scratch files under the workspace or `/tmp`.
