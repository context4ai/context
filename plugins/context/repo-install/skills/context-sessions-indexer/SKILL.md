...
description: Interpret saved conversation summaries for Context planning and writing. Use when the current authorized task selects this skill; not for importing sources or scanning conversation history.
metadata:
