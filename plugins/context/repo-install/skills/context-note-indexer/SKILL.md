...
description: Context-managed Provider for saved notes, excerpts and observations. Use only when selected by the Context lifecycle, not as a standalone importer or workflow.
metadata:
