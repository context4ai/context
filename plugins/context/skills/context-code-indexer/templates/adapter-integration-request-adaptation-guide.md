---
{
  ...
  "template_id": "adapter-integration-request-adaptation-guide",
  ...
  "page_policy": {
    "split_suggestion": "Trace an actual inbound registration through identity and field conversion, downstream calls, aggregation and response or error mapping. A generated client is not a server.",
    "semantic_boundaries": [
      "reader-task",
      "public-contract"
    ],
